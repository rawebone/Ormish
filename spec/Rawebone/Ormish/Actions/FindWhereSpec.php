...
class FindWhereSpec extends AbstractActionSpec
{
    function it_is_initializable()
    {
        $this->shouldHaveType('Rawebone\Ormish\Actions\FindWhere');
    }
     ...
     * @param \Rawebone\Ormish\Executor $ex
     */
    function it_should_return_an_empty_array_when_execution_fails($tbl, $gen, $ex)
    {
        $tbl->table()->willReturn("table");
        $gen->findWhere("table", "a = 1")->willReturn("query");
